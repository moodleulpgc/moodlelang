...
$string['pluginname_help'] = 'Ficheros asociados al área de texto actual del editor HTML y disponibles para ser enlazados en el texto o presentados si son imágenes.';
