...
$string['placeholder'] = '¿Qué cosas necesita hacer o recordar??';
$string['placeholdermore'] = 'Escriba lo que necesite y use el botón Agregar.';
$string['pluginname'] = 'Recordatorio';
