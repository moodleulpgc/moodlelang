...
/**
 * Strings for component 'qtype_pmatch', language 'es_mx', branch 'MOODLE_29_STABLE'
 *
...
$string['testquestionactualmark'] = 'Puntaje actual';
$string['testquestionexpectedmark'] = 'Puntaje esperado';
...
$string['testquestionformsubmit'] = 'Probar la pregunta usando estas respuestas';
...
$string['testquestionresultssummary'] = 'Calificada correctamente: <b>{$a->correct}</b>, incorrectamente calificada como errónea <b>{$a->incorrectlymarkedwrong}</b>, incorrectamente calificada como acertada <b>{$a->incorrectlymarkedright}</b>.';
