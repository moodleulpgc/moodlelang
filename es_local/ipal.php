...
/**
 * Strings for component 'ipal', language 'es', moodle ULPGC
 *
 * @package   ipal
...
$string['ipalname_help'] = 'Este es el contenido de la herramienta de ayuda asociada con el campo ipalname. La sintaxis Markdown está soportada.';
