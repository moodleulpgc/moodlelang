...
/**
 * Strings for component 'qcreate', language 'es', moodle ULPGC
 *
 * @package   qcreate
...
$string['eventeditpageviewed'] = 'Página de edición de redactar preguntas vista';
$string['eventoverviewviewed'] = 'Página de vista general de redactar preguntas vista';
...
$string['invalidqcreatezid'] = 'ID de redactar preguntas inválido';
...
$string['modulename'] = 'Redactar Preguntas';
$string['modulename_help'] = 'La actividad de redactar preguntass le permite a un profesor pedirle a los estudiantes que creen preguntas; pueden especificarse, el número de preguntas requeridas, los tipos de preguntas disponibles y el número de preguntas requeridas para cada tipo de pregunta.';
$string['modulenameplural'] = 'Redacciones de Preguntas';
...
$string['open_help'] = 'Usted puede especificar el horario en el que la actividad de redactar preguntass está accesible para que las personas hagan preguntas. Antes d ela hora de apertura, y después de la hora de cierre, los estudiantes no podrán crear preguntas.';
...
$string['qcreate:addinstance'] = 'Añadir una instancia de redactar preguntas';
$string['qcreate:grade'] = 'Calificar pregunta';
$string['qcreateopens'] = 'La acividad de redactar preguntas abre';
$string['qcreate:receivestudentnotifications'] = 'Recibir notificaciones para estudiante';
$string['qcreate:submit'] = 'Enviar pregunta';
$string['qcreate:view'] = 'Ver actividad de redactar preguntass';
$string['qcreatecloses'] = 'La acividad de redactar preguntas cierra';
$string['qcreateopens'] = 'La acividad de redactar preguntas abre';
...
$string['sendgradernotifications_help'] = 'Si s ehabilita, los calificadores (usualmente profesores) recibirán un mensaje cundo un estudiante cree una nueva pregunta. Los métos de mensajería son configurables.';
...
$string['timecreated'] = 'Hora de redactar preguntass';
...
$string['updategradestask'] = 'Actualizar calificaciones de la actividad de redactar preguntass';
